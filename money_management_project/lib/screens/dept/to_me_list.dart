...
class ToMeList extends StatelessWidget {
  const ToMeList({super.key});
      ...
      children: [
        Container(
          ...
          child: ValueListenableBuilder(
            valueListenable: DeptDb.instance.totalOwedToMeNotifier, 
            builder: (BuildContext ctx, double totalAmount, Widget? _){
              return Text('Total Amount Owed To Me: ${totalAmount.toString()} ₹', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white),);
            }),
        ),
        Expanded(
          child: ValueListenableBuilder(
            valueListenable: DeptDb.instance.forMeDeptList, 
